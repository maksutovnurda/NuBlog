<div class="addpost" onclick="showAddPostForm()"><i class="fa fa-plus"></i></div>
					<div class='addpost-form' style="display: none">
					 	<input type="text" id="title" placeholder="*Тақырып" class="addpost-input">
					 	<textarea id="stxt" cols="30" rows="10" placeholder="*Қысқа текст" class="addpost-text" spellcheck="false"></textarea>
					 	<div class="commands">
					    ...
					    <div id="textField" contenteditable="true" placeholder="asa" data-text="*Толық текст" class="textField" spellcheck="false"></div>
    					<textarea id="ftxt"></textarea>
					 	<input type="text" id="uri" placeholder="*Uri: kak-sdelat-fotoshop" class="addpost-input" onchange="checkUri()">
					 	<div id="validatorUri"></div>
					 	<input type="text" id="image" placeholder="Суретке сілтеме" class="addpost-input" onchange="showAlt()">
					 	<input type="text" id="alt" placeholder="*Суретке түсініктеме (alt)" class="addpost-input" style="display: none; background-color: #F0F0F0;">
					 	<textarea id="desc" cols="30" rows="10" placeholder="*Сипаттама 170 сөз" class="addpost-text" spellcheck="false" style="background-color: #F0F0F0"></textarea>
					 	<input type="text" id="keys" placeholder="*15 кілтсөз фотошоп дизайн как сделать макет" class="addpost-input" style="background-color: #F0F0F0">
					 	...
					 	<button onclick="addPost()">Жариялау</button>
					 	<div id="errorofadding"></div>
					</div>